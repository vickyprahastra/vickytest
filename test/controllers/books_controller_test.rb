...
class BooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book" do
    assert_difference('Book.count') do
      post books_url, params: { book: { author: @book.author, author_name: @book.author_name, authors: @book.authors, average_rating: @book.average_rating, category: @book.category, classes: @book.classes, content_available: @book.content_available, content_cleaned: @book.content_cleaned, content_name: @book.content_name, copyright: @book.copyright, countries: @book.countries, cover: @book.cover, description: @book.description, genres: @book.genres, goodreads: @book.goodreads, gutenberg: @book.gutenberg, images: @book.images, images_urls: @book.images_urls, int_id: @book.int_id, language: @book.language, loc_class: @book.loc_class, n_authors: @book.n_authors, release_date: @book.release_date, similar_books: @book.similar_books, title: @book.title, wikipedia: @book.wikipedia, year: @book.year } }
    end
